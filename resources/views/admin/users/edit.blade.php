                ...
                <form action="{{ route('users.update', $user) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label for="edit_username" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        ...
                        <div class="space-y-4">
                            <div>
                                <label for="edit_position" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                    Cargo
                                </label>
                            ...
                            <div>
                                <label for="edit_usertype" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label for="edit_password_confirmation" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex items-center">
                                    @if($user->profile_photo_path)
                                        ...
                                        @endphp
                                        <img src="{{ route('user.photo', $filename) }}" alt="Foto de perfil"
                                            class="h-20 w-20 rounded-full object-cover">
                                    @else
                                        <img src="{{ asset('admin/img/user.jpg') }}" alt="Foto de perfil"
                                            class="h-20 w-20 rounded-full object-cover">
                                    @endif
                                </div>
                            </div>
